...
// import portfolioRouter from './routes/portfolio.routes'; // We will add this next
...
// app.use('/api/portfolio', portfolioRouter); // We will uncomment this in the next step
